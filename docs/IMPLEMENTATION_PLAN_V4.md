...
Phase 45:  Multi-writer ack pipeline (W>1)   ████████░░░░░░░░░░░░  v6 🟡 In progress (tranche 1 delivered)
...
4. Consistency concerns still reject `W>1` with an explicit phase-45-in-progress
   error (`v6 phase 45 in progress: W>1 write acknowledgements are not enabled yet`).
5. `R>1` remains deferred to Phase 47.
6. E2E expectation updated to match the interim `W>1` rejection message.
